        ...
        <div className='overflow-y-auto flex-1 p-4'>
            <div className='flex justify-center'>
                <div className='flex flex-col items-center justify-center'>
                    ...
                    <Link to={`/profile/${selectedUser?._id}`}><Button className="h-8 my-2 bg-slate-200 border-2 border-gray-400 text-violet-600" variant="secondary">View profile</Button></Link>
                </div>
            </div>
