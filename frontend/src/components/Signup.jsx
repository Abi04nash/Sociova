        ...
        <div className='flex bg-slate-200 items-center w-screen h-screen justify-center'>
            <form onSubmit={signupHandler} className='bg-slate-50 rounded-2xl shadow-lg flex flex-col gap-5 p-8'>
                <div className='my-4'>
                    ...
                    <p className='text-sm text-center font-medium'>Sign up to start sharing your moments on <b className='bg-gradient-to-l from-violet-500 to-pink-500 bg-clip-text text-transparent'>Sociova</b> </p>
                </div>
                <div>
